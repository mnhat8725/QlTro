...
namespace QuanLyNhatro.Migrations
{
    ...
    [Migration("20251029094559_AddAnhChanDungToNguoiThue")]
            ...
            modelBuilder.Entity("QuanLyNhaTro.Models.HoaDon", b =>
                {
                    ...
                    b.Property<decimal?>("TienDichVuKhac")
                        .HasColumnType("decimal(18,2)");
            ...
            modelBuilder.Entity("QuanLyNhaTro.Models.HopDong", b =>
                {
                    ...
                    b.Property<int?>("NguoiThueId1")
                        .HasColumnType("int");

                    b.Property<int>("PhongId")
                        .HasColumnType("int");

                    b.Property<int?>("PhongId1")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("QuanLyNhaTro.Models.HopDong", b =>
                {
                    ...
                    b.HasOne("QuanLyNhaTro.Models.NguoiThue", null)
                        .WithMany("HopDongs")
                        .HasForeignKey("NguoiThueId1");
                    ...
                    b.HasOne("QuanLyNhaTro.Models.Phong", null)
                        .WithMany("HopDongs")
                        .HasForeignKey("PhongId1");
            ...
            modelBuilder.Entity("QuanLyNhaTro.Models.Phong", b =>
                {
                    ...
                    b.HasOne("QuanLyNhaTro.Models.LoaiPhong", null)
                        .WithMany("Phongs")
